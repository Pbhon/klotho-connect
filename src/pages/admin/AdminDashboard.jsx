...
import { subscribeToChapterEvents, getChapter, deleteEvent, getSignupCount } from '../../lib/firestore';
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    if (!events) return;
    events.forEach((ev) => {
      getSignupCount(ev.id).then((count) => setCounts((prev) => ({ ...prev, [ev.id]: count })));
    });
  }, [events]);
